      ...
      { 
       ...
       int i=1;
        ...
        { 
                ...
                Calculator obj = new Calculator(ds,DpReceive,receive,i); 
                obj.start(); 
                i++;
         }      
    } 
...
{ 
       ...
       byte []receive;
       int i;
      public Calculator( DatagramSocket ds,DatagramPacket DpReceive,byte []receive,int i)  
      { 
             this.ds = ds; 
     ...
     public void run()  
       {
          System.out.println("A new client is connected : "+i); 
    	  try
    	   {
